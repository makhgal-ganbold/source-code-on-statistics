...
bikers[168] <- paste0(bikers[168], '_', 2018)

# write.csv(x = as.data.frame(bikers), file = "bikers_2020.csv", row.names = FALSE)
...
bikers <- read.csv(file = "bikers_2020.csv")
user_ids <- bikers$id
...
# write.csv(x = rides, file = "rides_2020.csv", row.names = FALSE)
# Үүний дараа тус өгөгдөлд "ride_id" гэсэн багана нэмэв.
# Тус баганын утгуудыг өөр эх сурвалжаас олсон тул write.csv() функцийг ахин ажиллуулах хэрэггүй.
# Харин цааш үргэлжлүүлэхдээ дараах мөрд буй read.csv() функцийг ажиллуулж тийнхүү өөрчилсөн өгөгдлийг ачаална.

rides <- read.csv(file = "rides_2020.csv")
...
write.csv(x = ride_user, file = "ride_user_2020.csv", row.names = FALSE)
